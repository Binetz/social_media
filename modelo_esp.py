...
xdata = pd.read_csv('C:/QlikData/Redes/Gobierno Corrientes/DATA/CSV_SENTIMENT/coment_feature.csv').iloc[:, ]
...
pred_proba.to_csv('C:/QlikData/Redes/Gobierno Corrientes/DATA/CSV_SENTIMENT/pred_proba.csv', index=False)
